...
# Arrow
execute if score textAlign StampSettings matches 1 positioned ^0.5 ^5 ^0 rotated ~180 ~90 run function ttb:utility/particles/spawn_arrow
execute if score textAlign StampSettings matches 2 positioned ^0.5 ^5 ^0 rotated ~0 ~90 run function ttb:utility/particles/spawn_arrow