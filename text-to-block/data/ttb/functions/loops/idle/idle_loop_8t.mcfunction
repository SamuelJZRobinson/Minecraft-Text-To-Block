...
# Swap Axis
execute as @a[scores={StampUseCarrotStick=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{hToVAxis:1b}}}] at @s if block ~ ~-1 ~ structure_block run function ttb:utility/axis/flip_axis
