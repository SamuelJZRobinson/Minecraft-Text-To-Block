...
# Width 5
execute if score charID StampFont matches 57 run scoreboard players set charWidth StampFont 5
execute if score charID StampFont matches 66..67 run scoreboard players set charWidth StampFont 5