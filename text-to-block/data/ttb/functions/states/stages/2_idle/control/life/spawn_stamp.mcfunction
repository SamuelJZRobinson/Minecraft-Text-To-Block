...
execute if score stampExists StampStatus matches 0 if entity @e[type=armor_stand,team=Stamp,tag=stamp] run function ttb:error_handling/raise_warning {message:"Cannot spawn, stamp already exists!"}
