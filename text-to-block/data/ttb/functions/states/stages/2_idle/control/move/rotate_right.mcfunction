# Set Scores
execute if score stampExists StampStatus matches 1 run scoreboard players remove yaw StampStatus 90
execute if score stampExists StampStatus matches 1 if score yaw StampStatus matches ..-1 run scoreboard players set yaw StampStatus 270
