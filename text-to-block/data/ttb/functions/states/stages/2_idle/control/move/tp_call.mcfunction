...
# Get Coords
execute if score stampExists StampStatus matches 1 as @e[type=minecraft:armor_stand,team=Stamp,tag=stamp,limit=1] run function ttb:states/stages/2_idle/control/move/set_init_coords
