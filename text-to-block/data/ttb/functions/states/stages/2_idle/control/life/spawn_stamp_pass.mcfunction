# Spawn
execute at @s align xyz positioned ~0.5 ~ ~0.5 run summon armor_stand ~ ~ ~ {Team:"Stamp",NoGravity:1b,Invulnerable:1b,ShowArms:1b,Marker:1b,Tags:["stamp"],Pose:{LeftArm:[-40f,25f,0f],RightArm:[-40f,-25f,0f]},DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:player_head",count:1,components:{"minecraft:profile":{name:"MHF_enderman"}}}]}
