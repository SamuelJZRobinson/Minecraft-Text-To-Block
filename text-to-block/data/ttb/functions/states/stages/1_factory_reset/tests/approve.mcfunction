...
# Set Data
function ttb:states/1_factory_reset/set/set_gamerules
function ttb:states/1_factory_reset/set/set_teams
function ttb:states/1_factory_reset/set/scores/set_scores
function ttb:states/1_factory_reset/set/set_data
