...
# Warning
execute if score state StampStatus matches 2 if score stampExists StampStatus matches 0 run function ttb:error_handling/raise_warning {message:"Cannot call, need stamp!"}
execute if score state StampStatus matches 3.. run function ttb:error_handling/raise_warning {message:"Cannot call, already started!"}